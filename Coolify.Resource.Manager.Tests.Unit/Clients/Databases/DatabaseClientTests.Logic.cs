...
namespace Coolify.Resource.Manager.Tests.Unit.Clients.Databases
{
    public partial class DatabaseClientTests
    {
        ...
        public async Task ShouldRetrieveAllDatabasesAsync()
        {
            ...
            IEnumerable<Database> actualDatabases = await this.databaseClient.RetrieveAllDatabasesAsync();
        ...
        public async Task ShouldRetrieveDatabaseByUuidAsync()
        {
            ...
            Database actualDatabase = await this.databaseClient.RetrieveDatabaseByUuidAsync(inputDatabaseUuid);
        ...
        public async Task ShouldAddPostgreSqlDatabaseAsync()
        {
            ...
            PostgreSqlDatabase actualDatabase = await this.databaseClient.AddPostgreSqlDatabaseAsync(inputDatabase);
        ...
        public async Task ShouldModifyDatabaseAsync()
        {
            ...
            Database actualDatabase = await this.databaseClient.ModifyDatabaseAsync(inputDatabase);
        ...
        public async Task ShouldRemoveDatabaseAsync()
        {
            ...
            await this.databaseClient.RemoveDatabaseAsync(inputDatabaseUuid);
        ...
        public async Task ShouldRetrieveAllBackupsAsync()
        {
            ...
            IEnumerable<DatabaseBackup> actualBackups =
                await this.databaseClient.RetrieveAllBackupsAsync(inputDatabaseUuid);
        ...
        public async Task ShouldAddBackupAsync()
        {
            ...
            DatabaseBackup actualBackup = await this.databaseClient.AddBackupAsync(inputDatabaseUuid, inputBackup);
        ...
        public async Task ShouldModifyBackupAsync()
        {
            ...
            DatabaseBackup actualBackup = await this.databaseClient.ModifyBackupAsync(inputDatabaseUuid, inputBackup);
        ...
        public async Task ShouldRemoveBackupAsync()
        {
            ...
            await this.databaseClient.RemoveBackupAsync(inputDatabaseUuid, inputBackupUuid);
        ...
        public async Task ShouldRetrieveAllBackupExecutionsAsync()
        {
            ...
            IEnumerable<BackupExecution> actualExecutions =
                await this.databaseClient.RetrieveAllBackupExecutionsAsync(inputDatabaseUuid, inputBackupUuid);
        ...
        public async Task ShouldRemoveBackupExecutionAsync()
        {
            ...
            await this.databaseClient.RemoveBackupExecutionAsync(inputDatabaseUuid, inputBackupUuid, inputExecutionUuid);
        ...
        public async Task ShouldStartDatabaseAsync()
        {
            ...
            await this.databaseClient.StartDatabaseAsync(inputDatabaseUuid);
        ...
        public async Task ShouldStopDatabaseAsync()
        {
            ...
            await this.databaseClient.StopDatabaseAsync(inputDatabaseUuid);
        ...
        public async Task ShouldRestartDatabaseAsync()
        {
            ...
            await this.databaseClient.RestartDatabaseAsync(inputDatabaseUuid);
