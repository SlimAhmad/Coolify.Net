...
namespace Coolify.Net.Tests.Unit.Clients.PrivateKeys
{
    public partial class PrivateKeyClientTests
    {
        ...
        public async Task ShouldRetrieveAllPrivateKeysAsync()
        {
            ...
            IEnumerable<PrivateKey> actualPrivateKeys = await this.privateKeyClient.RetrieveAllPrivateKeysAsync();
        ...
        public async Task ShouldRetrievePrivateKeyByUuidAsync()
        {
            ...
            PrivateKey actualPrivateKey =
                await this.privateKeyClient.RetrievePrivateKeyByUuidAsync(inputPrivateKeyUuid);
        ...
        public async Task ShouldAddPrivateKeyAsync()
        {
            ...
            PrivateKey actualPrivateKey = await this.privateKeyClient.AddPrivateKeyAsync(inputPrivateKey);
        ...
        public async Task ShouldModifyPrivateKeyAsync()
        {
            ...
            PrivateKey actualPrivateKey = await this.privateKeyClient.ModifyPrivateKeyAsync(inputPrivateKey);
        ...
        public async Task ShouldRemovePrivateKeyAsync()
        {
            ...
            await this.privateKeyClient.RemovePrivateKeyAsync(inputPrivateKeyUuid);
